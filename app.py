...
from agent import (get_conversation_response, analyze_session,
                   analyze_progress, score_to_label, extract_suggestion)
...
# Create tables on startup - runs whether started by gunicorn or dev server
...
def chat_finish():
    ...
    review_turns = []
    for t in turns:
        suggestion = extract_suggestion(t["fluency_comment"], t["student_speech"])
        review_turns.append({
            "question":         t["app_question"],
